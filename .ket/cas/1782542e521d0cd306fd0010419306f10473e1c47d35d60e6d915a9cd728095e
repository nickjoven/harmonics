...
**Source**: commit `e06684a`, **commit body only**. The cited
`a_s_alpha2_phase_b.md` was never added to the tree (verified
2026-05-28 audit: `git log --all --diff-filter=A -- '*a_s_alpha2_phase_b*'`
returns 0 hits). N12's three sub-gaps stand as recorded here; the
canonical derivation never landed as a doc.
