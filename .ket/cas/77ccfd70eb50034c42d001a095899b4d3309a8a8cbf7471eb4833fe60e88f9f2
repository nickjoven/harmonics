...
| Friedmann form at r = 1 — *canonically affirmed structural* (S1–S2; S3–S5 = open N9 null); affirmed alongside R, Λ·ℓ_P² | `k_of_t_friedmann.md`, `numerology_inventory.md` "What remains genuinely structural" #1 |
