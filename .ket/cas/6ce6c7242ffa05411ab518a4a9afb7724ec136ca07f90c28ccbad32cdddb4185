...
| D4 | [`spectral_tilt_reframed.md`](spectral_tilt_reframed.md) | inferred: `MANIFEST.spectral_tilt.source[0]` + subject match. Remapped 2026-07-21: `spectral_tilt.md` (Derivation 02) declares itself "Superseded by Derivation 04" and names `spectral_tilt_reframed.md` as that derivation; MANIFEST's Class-5 language ("staircase self-similarity at the golden-ratio winding") describes the reframed doc, not the superseded cost-function doc. Also cited in `fermion_mass_running.md:99` for staircase scaling. |
...
| D16 | [`variable_denominator.md`](variable_denominator.md) | inferred: `klein_bottle.md` "Derivation 16" cites + (-1)^n ψ-eigenvalue content match (its L273-275) |
| D18 | [`mobius_container.md`](mobius_container.md) | inferred: `klein_bottle.md` "Derivation 18" cites + title/one-boundary container content match |
...
| D38 | [`boundary_weight.md`](boundary_weight.md) | inferred: `baryon_fraction.md` D38 cite + w* = 0.83 effective-depth content match (its L145-172) |
