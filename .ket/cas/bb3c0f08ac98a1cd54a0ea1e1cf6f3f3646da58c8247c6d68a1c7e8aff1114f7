...
value matches W within tolerance. This avoids the binary-search
tolerance pathology in circle_map.tongue_width (where tol = 1e-8
on a winding number computed with 5000 iterations is never
satisfied for low-K locked tongues, collapsing all widths to 0).
