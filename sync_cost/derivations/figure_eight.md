...
**Class 1** for the headline `sin²θ_W = 8/35` numerical claim (and the
inherited `M_W/M_Z = √(27/35)`) — confirmed numerology per
`numerology_inventory.md` and `sinW_running_check.py`; see disposition
flag 1. The figure-8-is-the-structure claim itself is separately Class 2
(re-description, not substrate-forced) per
`figure_eight_necessitation_audit.md` (PR #214). [#263 ⓾ ruling,
2026-07-19]
