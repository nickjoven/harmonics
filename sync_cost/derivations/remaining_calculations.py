...
print("=" * 70)
print("CALC 4: HIGGS POTENTIAL V(H) -- RETRACTED, SEE NOTE BELOW")
print("=" * 70)
print()
print("NOTE (cleanup pass):")
print("  The cosine Taylor expansion below gives lambda = K/24 ~ 0.042")
print("  at K = 1, which is 3x too small and does NOT match the")
print("  framework's duty-cycle dictionary. The correct structural")
print("  form is")
print("      lambda = 1/q_2^3 = duty(q_2) = alpha_2(tree) = 1/8")
print("  forced by sin^2(theta_W) = 8/35 (see item12_higgs_degeneracy.py).")
print("  The alternative 1/(2 q_2^2) = 1/8 form is numerically equal at")
print("  q_2 = 2 but gives sin^2 = 4/13 at q_3 = 3, which is wrong.")
print("  Form B (1/q^d) is forced.")
print()
print("  The cosine Taylor expansion below is historical -- do NOT cite")
print("  lambda = K/24 as a current framework prediction.")
print()
print("--- Historical / retracted derivation ---")
print()
