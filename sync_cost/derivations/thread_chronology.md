...
doc + one-line path, with a minimized loud list of the only
genuinely-open items (#ANCHOR two-anchor re-audit, #PROPOSED
longer-horizon; #INF now closed → Resolved) — so no other doc
