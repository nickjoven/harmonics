...
| `41_discrete_gauge_resolution.md` | **Current** | Resolves D20/D21. Path 2 closed (Jacobian rank-1). Path 1 partial: charges, center Z₆, confinement correct; dynamics (Yang-Mills) not derived. Gauge structure is discrete, not continuum. Gap remaining: uniqueness of Yang-Mills given kinematic constraints (gauge-sector Lovelock). |
