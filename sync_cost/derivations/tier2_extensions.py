...
print("level (~21) depends on the k↔ω mapping rate (2/57 ≈ 0.0351 levels per")
print("e-fold; substrate-forced cadence per PRs #178/#179, see")
print("minimum_alphabet.md §3. Earlier n_s-anchored ≈ 0.0365 superseded.")
print("Re-derivation of depth-21 under 2/57 is flagged Wave-2 — pivot may")
print("shift by ~0.5 Fibonacci levels; see a_s_geometric_proof.md).")
