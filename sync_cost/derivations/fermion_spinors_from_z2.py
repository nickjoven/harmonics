...
print()
print("Neutrinos (|Q| = 0):")
print("   ν_e:          depth 37 in gap region")
print("   ν_μ:          depth 36")
print("   ν_τ:          depth 35")
print()
print("Each fermion is a spinor ψ on the Klein bottle × Stern-Brocot")
print("tree, with a specific walk that determines its mass via the")
print("Yukawa coupling y_f = walk product.")
print()
